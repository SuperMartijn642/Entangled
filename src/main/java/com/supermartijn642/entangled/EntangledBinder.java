...
public class EntangledBinder extends Item {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn){
        ...
        if(tag.contains("bound") && tag.getBoolean("bound")){
            ...
            ITextComponent dimension = TextComponents.dimension(RegistryKey.func_240903_a_(Registry.WORLD_KEY, new ResourceLocation(tag.getString("dimension")))).color(TextFormatting.GOLD).get();
