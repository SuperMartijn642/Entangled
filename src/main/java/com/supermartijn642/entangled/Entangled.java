...
public class Entangled {
    ...
    public static class RegistryEvents {
        ...
        public static void onItemRegistry(final RegistryEvent.Register<Item> e){
            e.getRegistry().register(new BlockItem(block, new Item.Properties().tab(ItemGroup.TAB_SEARCH).setISTER(() -> EntangledBlockItemStackTileEntityRenderer::new)).setRegistryName("block"));
